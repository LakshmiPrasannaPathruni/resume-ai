...
def load_model():
    global model, job_embeddings, job_titles
...
def categorize_skill(skill):
    ...
    if any(word in skill for word in [
        "python", "sql", "java", "cloud", "ai", "ml", "data", "software", "programming"
    ]):
        return "Technical Skills"

    elif any(word in skill for word in [
        "manage", "plan", "lead", "organize", "budget"
    ]):
...
def find_skills_for_job(job_title: str):
    ...
    print(f"🔍 Searching for job title: {query}")
